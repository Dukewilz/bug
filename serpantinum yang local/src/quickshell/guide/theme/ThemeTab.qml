...
Item {
    ...
    Flickable {
        ...
        ColumnLayout {
            ...
            Rectangle {
                Layout.fillWidth: true
                implicitHeight: fontWeightRow.implicitHeight + rootObj.s(18)
                color: "transparent"
                ...
                ColumnLayout {
                    ...
                    ColumnLayout {
                        Layout.fillWidth: true
                        spacing: rootObj.s(2)
                        Text { text: "UI font weight"; font.family: ThemeBackend.fontFamily; font.pixelSize: rootObj.s(13); color: ThemeBackend.text }
                        Text { text: "Adjust text thickness, including the lock-screen clock"; font.family: ThemeBackend.fontFamily; font.pixelSize: rootObj.s(11); color: ThemeBackend.subtext0 }
                    }
                    ...
                    Draggable {
                        ...
                        to: 900
                        stepSize: 100
                        defaultValue: Font.DemiBold
                        showValueBubble: true
                        valueFormatter: function(v) {
                            let names = {100: "Thin", 200: "Extra light", 300: "Light", 400: "Regular", 500: "Medium", 600: "Demi bold", 700: "Bold", 800: "Extra bold", 900: "Black"};
                            return names[Math.round(v)] || Math.round(v);
                        }
                        value: themeTabRoot.currentFontWeight
                        backgroundColor: ThemeBackend.surface0
                        accentColor: ThemeBackend.mauve
                        handleColor: ThemeBackend.text
                        handleBorderColor: ThemeBackend.mantle
                        onMoved: function(val) {
                            themeTabRoot.currentFontWeight = Math.round(val / 100) * 100;
                            appearanceDebounceTimer.restart();
                        }
                        onDragFinished: {
                            appearanceDebounceTimer.stop();
            ...
            Rectangle {
                Layout.fillWidth: true
                implicitHeight: acrylicColumn.implicitHeight + rootObj.s(24)
                radius: ThemeBackend.clampedBorderRadius
                color: Qt.alpha(ThemeBackend.surface0, 0.52)
                border.width: 1
                border.color: Qt.alpha(ThemeBackend.surface2, 0.30)
                ...
                ColumnLayout {
                    ...
                    ColumnLayout {
                        ...
                        Text { text: "Acrylic wallpaper, blur, opacity, and adaptive ambient contrast for popups"; font.family: ThemeBackend.fontFamily; font.pixelSize: rootObj.s(10.5); color: ThemeBackend.subtext0 }
                    }
                    ...
                    ColumnLayout {
                        ...
                        ColumnLayout {
                            Layout.fillWidth: true
                            spacing: rootObj.s(1)
                            Text { text: "Use current wallpaper"; font.family: ThemeBackend.fontFamily; font.pixelSize: rootObj.s(12); color: ThemeBackend.text }
                            Text { text: "Crop and blur the wallpaper inside each popup"; font.family: ThemeBackend.fontFamily; font.pixelSize: rootObj.s(10); color: ThemeBackend.subtext0 }
                        }
                        Toggle {
                            Layout.alignment: Qt.AlignLeft
                    ...
                    GridLayout {
                        ...
                        ColumnLayout {
                            Layout.preferredWidth: rootObj.s(248)
                            Text { text: "Surface opacity"; font.family: ThemeBackend.fontFamily; font.pixelSize: rootObj.s(11); color: ThemeBackend.text }
                            Draggable {
                                implicitWidth: rootObj.s(238); implicitHeight: rootObj.s(18); from: 35; to: 100; stepSize: 1; defaultValue: 96
                                showValueBubble: true; valueFormatter: function(v) { return Math.round(v) + "%" }
                                value: themeTabRoot.currentUiOpacity; backgroundColor: ThemeBackend.surface1; accentColor: ThemeBackend.mauve; handleColor: ThemeBackend.text; handleBorderColor: ThemeBackend.mantle
                        ...
                        ColumnLayout {
                            Layout.preferredWidth: rootObj.s(248)
                            Text { text: "Gaussian blur"; font.family: ThemeBackend.fontFamily; font.pixelSize: rootObj.s(11); color: ThemeBackend.text }
                            Draggable {
                                implicitWidth: rootObj.s(238); implicitHeight: rootObj.s(18); from: 0; to: 100; stepSize: 1; defaultValue: 68
                                showValueBubble: true; valueFormatter: function(v) { return Math.round(v) + "%" }
                                value: themeTabRoot.currentUiBlur; backgroundColor: ThemeBackend.surface1; accentColor: ThemeBackend.sapphire; handleColor: ThemeBackend.text; handleBorderColor: ThemeBackend.mantle
                        ...
                        ColumnLayout {
                            Layout.preferredWidth: rootObj.s(248)
                            Layout.columnSpan: 2
                            Text { text: "Dynamic ambient visibility"; font.family: ThemeBackend.fontFamily; font.pixelSize: rootObj.s(11); color: ThemeBackend.text }
                            Draggable {
                                implicitWidth: rootObj.s(238); implicitHeight: rootObj.s(18); from: 35; to: 180; stepSize: 1; defaultValue: 100
                                showValueBubble: true; valueFormatter: function(v) { return Math.round(v) + "%" }
                                value: themeTabRoot.currentAmbientStrength; backgroundColor: ThemeBackend.surface1; accentColor: ThemeBackend.blue; handleColor: ThemeBackend.text; handleBorderColor: ThemeBackend.mantle
                    ...
                    ColumnLayout {
                        ...
                        ColumnLayout {
                            Layout.fillWidth: true
                            spacing: rootObj.s(1)
                            Text { text: "Wallpaper transition"; font.family: ThemeBackend.fontFamily; font.pixelSize: rootObj.s(12); color: ThemeBackend.text }
                            Text { text: "Imperative-style random motion without repeating the previous direction"; font.family: ThemeBackend.fontFamily; font.pixelSize: rootObj.s(10); color: ThemeBackend.subtext0 }
                        }

                        Reusables.Switch {
                            Layout.alignment: Qt.AlignLeft
                            implicitWidth: rootObj.s(250)
                        ...
                        ColumnLayout {
                            Layout.alignment: Qt.AlignLeft
                            spacing: rootObj.s(4)
                            Text { text: "Transition duration"; font.family: ThemeBackend.fontFamily; font.pixelSize: rootObj.s(11); color: ThemeBackend.text }
                            NumberSelector {
