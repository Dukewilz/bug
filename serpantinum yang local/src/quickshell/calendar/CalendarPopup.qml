...
Item {
    ...
    Item {
        ...
        Rectangle {
            ...
            color: Qt.alpha(window.base, ThemeBackend.uiBackgroundOpacity)
            ...
            Rectangle {
                ...
                opacity: 0.026 * window.introAmbient
            ...
            Rectangle {
                ...
                opacity: 0.021 * window.introAmbient
            ...
            Item {
                ...
                Text {
                    ...
                    SequentialAnimation on opacity {
                        loops: Animation.Infinite
                        running: window.visible
                        NumberAnimation { from: 0.028; to: 0.043; duration: 5625; easing.type: Easing.OutSine }
                        NumberAnimation { from: 0.043; to: 0.021; duration: 11250; easing.type: Easing.InOutSine }
                        NumberAnimation { from: 0.021; to: 0.028; duration: 5625; easing.type: Easing.InSine }
                    }
