    ...
    delegate: Component {
        PanelWindow {
            ...
            property bool barConfigReady: {
                ...
                // Existing settings may be valid while still lacking a newer
                // optional bar key.  All bar properties below already have
                // fallbacks, so requiring `autohide` here hides the whole bar
                // until the Guide happens to rewrite the configuration.
                return true;
            }
            ...
            // Compatibility contract consumed by existing widget modules.
            // It now controls content only; surface drawing uses barSurfaceOpacity.
