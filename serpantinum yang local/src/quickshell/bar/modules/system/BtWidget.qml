...
Rectangle {
    ...
    property bool adapterPresent: Bluetooth.defaultAdapter !== null && Bluetooth.defaultAdapter !== undefined
    ...
    // Desktop systems can have a real USB/PCI Bluetooth adapter. Visibility
    // follows adapter availability instead of chassis type.
    property real targetWidth: (moduleActive && adapterPresent && sysLayout.implicitWidth > 0) ? (sysLayout.implicitWidth + barWindow.s(10)) : 0
    width: targetWidth

    opacity: (showLayout && moduleActive && adapterPresent) ? ((barWindow && barWindow.barOpacity !== undefined) ? barWindow.barOpacity : 1.0) : 0.0
    visible: opacity > 0
    ...
    Row {
        ...
        ClickButton {
            ...
            property real targetWidth: adapterPresent ? implicitWidth : 0
            width: targetWidth
